...
export const translations = {
  zh: {
    ...
    common: { save_failed: "保存失败，请重试", delete_failed: "删除失败，请重试", copy_failed: "复制失败" },
    ...
    profile: { title: "个人中心", logout: "登出当前账户", settings: "账号设置", language: "语言设置", industry: "所在行业", industry_placeholder: "请选择行业", notifications: "消息提醒", security: "安全与隐私", avatar: "更换头像", theme: "界面风格", theme_classic: "经典蓝", theme_dark: "极客黑", theme_orange: "活力橙", theme_nature: "森林绿", ai_config: "AI 引擎配置", api_key_label: "自定义 API Key", api_key_placeholder: "粘贴 Google Gemini API Key...", model_select: "模型选择", model_flash: "Gemini 3 Flash", model_flash_desc: "速度快，延迟低", model_pro: "Gemini 3 Pro", model_pro_desc: "推理强，更智能" },
  ...
  en: {
    ...
    common: { save_failed: "Save failed, please retry", delete_failed: "Delete failed, please retry", copy_failed: "Copy failed" },
  ...
  ja: {
    ...
    common: { save_failed: "保存に失敗しました。再試行してください", delete_failed: "削除に失敗しました。再試行してください", copy_failed: "コピーに失敗しました" },
    ...
    interaction_detail: {
      ...
      link_customer: "関連顧客", change_link: "関連を変更", unlink: "関連を解除", no_linked_customer: "未関連",
      link_search_placeholder: "名前・会社で検索", link_add_customer: "顧客を追加", link_new_customer_form: "新規顧客情報を入力", link_btn: "関連", add_btn: "追加", unlink_btn: "解除",
      edit: "編集", save: "保存", cancel: "キャンセル", add_step: "追加", remove: "削除",
      priority_label: "優先度", priority_high: "高", priority_medium: "中", priority_low: "低"
    },
    history: { title: "すべての復盤", subtitle: "すべての復盤記録と構造化データ", search_placeholder: "名前、会社、要約で検索...", filter: "フィルター", sort: "並び替え", filter_all: "すべて", empty_title: "一致する復盤記録がありません", empty_hint: "キーワードや音声検索をお試しください", detail: "詳細", date: "日付", customer_company: "顧客・会社", stage: "ステージ", sentiment: "感情", action: "操作", voice_search: "音声検索", stop_recording: "録音停止", report: "レポート", report_title: "レポート生成", date_range: "期間", today: "今日", yesterday: "昨日", this_week: "今週", last_7_days: "過去7日", last_week: "先週", last_30_days: "過去30日", this_month: "今月", last_month: "先月", this_quarter: "今四半期", last_quarter: "前四半期", this_year: "今年", last_year: "去年", custom: "カスタム", start_date: "開始日", end_date: "終了日", generate: "生成", copy: "コピー", report_placeholder: "レポート内容がここに表示されます...", generating_report: "レポートを生成中...", report_style_brief: "簡潔", report_style_detailed: "詳細", copy_failed: "コピーに失敗しました" },
    login: { 
  ...
  ko: {
    ...
    common: { save_failed: "저장에 실패했습니다. 다시 시도해 주세요", delete_failed: "삭제에 실패했습니다. 다시 시도해 주세요", copy_failed: "복사 실패" },
