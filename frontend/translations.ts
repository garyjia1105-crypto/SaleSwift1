...
export const translations = {
  zh: {
    ...
    new: { title: "客户互动复盘", subtitle: "整理今日访谈，沉淀销售情报", record: "录音", stop: "停止", placeholder: "粘贴访谈摘要或手动输入访谈内容...", analyze: "生成 AI 结构化报告", analyzing: "正在深度分析...", upload: "上传文件", change_file: "更换文件", match_customer: "自动匹配客户", recent_records: "最近复盘记录", all: "全部", link_profile_title: "关联客户档案", cancel: "取消", new_client: "新建客户", create_new_client: "新建客户", name_placeholder: "姓名", company_placeholder: "公司", confirm_review: "确认并查看", saving: "保存中..." },
