...
export const translations = {
  zh: {
    ...
    interaction_detail: {
      ...
      link_search_placeholder: "搜索姓名、公司", link_add_customer: "添加客户", link_btn: "关联", add_btn: "添加", unlink_btn: "取消",
  ...
  en: {
    ...
    interaction_detail: {
      ...
      link_search_placeholder: "Search name, company", link_add_customer: "Add client", link_btn: "Link", add_btn: "Add", unlink_btn: "Unlink",
  ...
  ja: {
    ...
    interaction_detail: {
      ...
      link_search_placeholder: "名前・会社で検索", link_add_customer: "顧客を追加", link_btn: "関連", add_btn: "追加", unlink_btn: "解除",
  ...
  ko: {
    ...
    interaction_detail: {
      ...
      link_search_placeholder: "이름·회사 검색", link_add_customer: "고객 추가", link_btn: "연결", add_btn: "추가", unlink_btn: "해제",
