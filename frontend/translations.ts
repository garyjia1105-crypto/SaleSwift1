...
export const translations = {
  zh: {
    ...
    new: { title: "客户互动复盘", subtitle: "整理今日访谈，沉淀销售情报", record: "录音", stop: "停止", placeholder: "粘贴会议摘要或手动输入笔记...", analyze: "生成 AI 结构化报告", analyzing: "正在深度分析...", upload: "上传文件", change_file: "更换文件", match_customer: "自动匹配客户", recent_records: "最近复盘记录", link_profile_title: "关联客户档案", cancel: "取消", new_client: "新建客户", create_new_client: "新建客户", name_placeholder: "姓名", company_placeholder: "公司", confirm_review: "确认并查看", saving: "保存中..." },
    ...
    customers: { title: "客户档案库", subtitle: "支持语音搜索与快速建档", add: "新增", search: "搜索姓名、公司或标签...", filter_all: "全部", empty: "未找到档案", manual_title: "手动录入", name: "姓名 *", company: "公司 *", tags: "标签 (空格分隔)", save: "保存档案", funnel: "销售阶段漏斗", funnel_empty: "添加客户或互动后显示漏斗" },
    customer_detail: { 
      ...
      course_plan: "AI 课程规划", gen_course: "生成规划", generating: "规划中...", plan_title: "定制培训方案", plan_objective: "培训目标", plan_modules: "课程模块", plan_resources: "推荐资源", no_plan: "暂无课程规划", not_found: "未找到该客户", back_to_list: "返回列表", role_placeholder: "职位", company_placeholder: "公司"
    },
    interaction_detail: {
    ...
    history: { title: "互动历史记录", subtitle: "回顾您过去所有的对话和结构化数据。", search_placeholder: "通过姓名、公司或摘要内容搜索...", filter: "筛选", sort: "排序", empty_title: "未找到匹配的互动记录", empty_hint: "尝试更换关键词或使用语音搜索", detail: "详情", date: "日期", customer_company: "客户与公司", stage: "当前阶段", sentiment: "情绪基调", action: "操作", voice_search: "语音搜索", stop_recording: "停止录音" },
    login: { forget_password_coming_soon: "功能开发中，敬请期待。" }
  },
  en: {
    ...
    new: { title: "Meeting Review", subtitle: "Organize today's talk into intelligence", record: "Rec", stop: "Stop", placeholder: "Paste meeting notes or type here...", analyze: "Generate AI Report", analyzing: "Analyzing...", upload: "Upload", change_file: "Change", match_customer: "Match Client", recent_records: "Recent Interactions", link_profile_title: "Link Customer Profile", cancel: "Cancel", new_client: "New Client", create_new_client: "Create New Client", name_placeholder: "Name", company_placeholder: "Company", confirm_review: "Confirm & Review", saving: "Saving..." },
    ...
    customer_detail: { 
      ...
      course_plan: "AI Course Plan", gen_course: "Gen Plan", generating: "Planning...", plan_title: "Custom Curriculum", plan_objective: "Objective", plan_modules: "Modules", plan_resources: "Resources", no_plan: "No plan generated", not_found: "Customer not found", back_to_list: "Back to list", role_placeholder: "Role", company_placeholder: "Company"
    },
    interaction_detail: {
    ...
    history: { title: "Interaction History", subtitle: "Review all your past conversations and structured data.", search_placeholder: "Search by name, company or summary...", filter: "Filter", sort: "Sort", empty_title: "No matching interactions", empty_hint: "Try different keywords or voice search", detail: "Detail", date: "Date", customer_company: "Customer & Company", stage: "Stage", sentiment: "Sentiment", action: "Action", voice_search: "Voice search", stop_recording: "Stop recording" },
    login: { forget_password_coming_soon: "Coming soon. Stay tuned." }
  },
  ja: {
    ...
    customers: { title: "顧客データベース", subtitle: "音声検索とクイック登録", add: "新規", search: "名前、会社、タグで検索...", filter_all: "すべて", empty: "データが見つかりません", manual_title: "手动登録", name: "名前 *", company: "会社 *", tags: "タグ (スペース区切り)", save: "保存", funnel: "販売ファンネル", funnel_empty: "顧客またはインタラクションを追加すると表示されます" },
    customer_detail: { 
      ...
      course_plan: "AI カリキュラム", gen_course: "作成", generating: "作成中...", plan_title: "カスタムプラン", plan_objective: "目的", plan_modules: "モジュール", plan_resources: "リソース", no_plan: "カリキュラムなし", not_found: "顧客が見つかりません", back_to_list: "一覧に戻る", role_placeholder: "役職", company_placeholder: "会社"
    },
    interaction_detail: {
    ...
    history: { title: "インタラクション履歴", subtitle: "過去の会話と構造化データを確認。", search_placeholder: "名前、会社、要約で検索...", filter: "フィルター", sort: "並び替え", empty_title: "一致する記録がありません", empty_hint: "キーワードや音声検索をお試しください", detail: "詳細", date: "日付", customer_company: "顧客・会社", stage: "ステージ", sentiment: "感情", action: "操作", voice_search: "音声検索", stop_recording: "録音停止" },
    login: { forget_password_coming_soon: "準備中です。少々お待ちください。" }
  },
  ko: {
    ...
    customers: { title: "고객 데이터베이스", subtitle: "음성 검색 및 빠른 등록", add: "추가", search: "이름, 회사, 태그 검색...", filter_all: "전체", empty: "기록을 찾을 수 없습니다", manual_title: "수동 등록", name: "이름 *", company: "회사 *", tags: "태그 (공백으로 구분)", save: "프로필 저장", funnel: "영업 퍼널", funnel_empty: "고객 또는 상호작용 추가 시 표시됨" },
    customer_detail: { 
      ...
      course_plan: "AI 교육 플랜", gen_course: "플랜 생성", generating: "생성 중...", plan_title: "맞춤형 커리큘럼", plan_objective: "목표", plan_modules: "커리큘럼", plan_resources: "추천 리소스", no_plan: "교육 플랜 없음", not_found: "고객을 찾을 수 없습니다", back_to_list: "목록으로", role_placeholder: "직책", company_placeholder: "회사"
    },
    interaction_detail: {
    ...
    history: { title: "상호작용 기록", subtitle: "과거 대화와 구조화된 데이터를 확인하세요.", search_placeholder: "이름, 회사, 요약으로 검색...", filter: "필터", sort: "정렬", empty_title: "일치하는 기록이 없습니다", empty_hint: "다른 키워드나 음성 검색을 시도해 보세요", detail: "상세", date: "날짜", customer_company: "고객 및 회사", stage: "단계", sentiment: "감정", action: "작업", voice_search: "음성 검색", stop_recording: "녹음 중지" },
    login: { forget_password_coming_soon: "준비 중입니다. 곧 만나요." }
  }
};
